    ...
    <div>
      ...
      <div className="flex-container">
        <div className="leftdet">
          ...
          <div>
            <img src={moviedetails.poster_url} alt={title} />
          </div>
        </div>
        <div className="middledet">
          ...
          <YouTube videoId={trailer_url} opts={opts} ready={_onReady} />
        </div>
        <div className="right">
          <div>
            <Typography>
          ...
          <div>
            {/*GridList Item is deprecated so ImageList Item used */}
